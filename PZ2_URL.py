...
def URL_to_dict(strURL):
    ...
    if index > 0:
        ...
        if index > 0:
            dict_result["username"] = strURL_uspass[:index]
...
def joinURL(strURL1, strURL2):
    ...
    if dictURL2 != None:
        if dictURL2['path'] == "":
            strURL = dictURL2['scheme'] + "://" + dictURL2['domain']
        else:
            strURL = dictURL1['scheme'] + "://" + dictURL1['domain']
...
def testJoinURL():
    ...
    # print urlparse.urljoin("http://a.com/x", "http://b.com")
    # print urlparse.urljoin("http://a.com/x", "/a/b/c")
    # print urlparse.urljoin("http://a.com/x", "a/b/c")
    # print urlparse.urljoin("//a.com/x", "a/b/c")
    # print urlparse.urljoin("", "")
    # print urlparse.urljoin("", "a/b/c")
    # print urlparse.urljoin("http://a.com/x", "")
